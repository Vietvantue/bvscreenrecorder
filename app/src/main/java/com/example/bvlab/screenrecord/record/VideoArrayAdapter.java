package com.example.bvlab.screenrecord.record;
...
import com.example.bvlab.screenrecord.trimvideo.EditVideoActivity;
...
//        Log.e("video uri", "file://" + listVideo.getVideo_uri());
    ...
    public void moreOption(final ViewHolder viewHolder, View v) {
        ...
        popup.show();
        videoSelectedPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + mContext.getResources().getString(R.string.string_store_video_folder) + "/" + viewHolder.video_Name.getText();
                ...
                null, new MediaScannerConnection.OnScanCompletedListener() {
                    public void onScanCompleted(String path, Uri uri) {
                        ...
                        mContext.startActivity(Intent.createChooser(shareIntent,
                                mContext.getString(R.string.string_sharevideo)));
